...
public class ApGUI 
    ...
    private void pValSeqComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_pValSeqComponentShown
        this.observerValSeq((AP)getModeloFormal());
   ...
   private void removeActionSimP() {
    ...
    public ModeloFormal getModeloFormal() {
        ...
        // Add Estado Inicial
        Object o = this.cbSimbIni.getSelectedItem();
        if(o!=null)
            ap.setEstadoInicial(new Estado(o.toString()));
        
        // Add Simbolo do topo da pilha
        o =  this.cbSimbIniPilha.getSelectedItem();
        if(o!=null)
            ap.setTopoPilha(new Simbolo(
                o.toString().charAt(0)));
