...
// TODO adicione seu código de manipulação aqui:
    ...
    private void bAFNDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAFNDActionPerformed
        this.showFormalModel(IdFormalModels.AFND);
    ...
    private void bAFDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bAFDActionPerformed
       this.showFormalModel(IdFormalModels.AFD);
...
// TODO adicione seu código de manipulação aqui:
    ...
    private void actionSair() {
        int i = jop.showConfirmDialog(this,
                "Deseja Sair do Sistema?","",jop.YES_NO_OPTION);
    ...
    private void showFormalModel(int idFormalModel) {        
        this.addJIF(
                new GenericJInternalFrame(ctrl, idFormalModel));
    }
