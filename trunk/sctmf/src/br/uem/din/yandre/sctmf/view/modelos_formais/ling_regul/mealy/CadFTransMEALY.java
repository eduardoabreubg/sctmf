 ...
 */
public class CadFTransMEALY extends javax.swing.JPanel {
    ...
    /** Creates new form CadFTransMEALY */
    public CadFTransMEALY(MealyGUI gui) {
        this.gui = gui;
        initComponents();
        posInitComponents();
    }
     ...
     */
    void observer(
            Simbolo s, boolean oper, int alf) {
