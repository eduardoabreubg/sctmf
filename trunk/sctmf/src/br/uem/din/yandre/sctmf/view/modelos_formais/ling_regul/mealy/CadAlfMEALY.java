 ...
 */
public class CadAlfMEALY extends javax.swing.JPanel {

    MealyGUI gui = null;

    /** Creates new form CadAlfMEALY */
    public CadAlfMEALY(MealyGUI gui) {
        this.gui = gui;
        initComponents();
        posInitComponents();
    }
    ...
    Set<Simbolo> getSimbAfabetoSaida() {
        Set<Simbolo> simbolos = new LinkedHashSet<Simbolo>();
        for (Object o : this.listAlfSaida.getAllItens()) {
            simbolos.add(new Simbolo((Character) o));
        }
    ...
    void setSimbAfabetoSaida(Collection<Simbolo> simbAlfSaida) {
        this.listAlfSaida.removeAllItens();

        for (Simbolo s : simbAlfSaida) //this.listAlfAux.addItem(s.getNome());
        {
            this.addActionAlfSaida(s);
        }
    }
    ...
    private void initComponents() {
        ...
        listAlfSaida = new br.uem.din.yandre.sctmf.view.components.GenericJList();
        jLabel5 = new javax.swing.JLabel();
        addRemButtonsAlf = new br.uem.din.yandre.sctmf.view.components.AddRemButtonsPanel();
        addRemButtonsAlfSaida = new br.uem.din.yandre.sctmf.view.components.AddRemButtonsPanel();
        ...
        listAlfSaida.setToolTipText("");
        jPanel5.add(listAlfSaida, java.awt.BorderLayout.CENTER);

        jLabel5.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setToolTipText("Alfabeto Saída(Pode se Vazio)");
        jLabel5.setText("\u0394");
        ...
        add(addRemButtonsAlfSaida, gridBagConstraints);
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
    ...
    private void posInitComponents() {
        ...
        this.addRemButtonsAlfSaida.getBAdd().addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent ae) {
                addActionAlfSaida(null);
            }
        });

        this.addRemButtonsAlfSaida.getBRemove().addActionListener(new ActionListener() {

            public void actionPerformed(ActionEvent ae) {
                removeActionAlfSaida();
            }
        });
    }
    ...
    private void removeActionAlfSaida() {
        for (Object o : this.listAlfSaida.removeItens()) {
            this.gui.removeSimbolo(
                    new Simbolo((Character) o), 1);
        }
    }

    private void addActionAlfSaida(Simbolo simbAlfSaida) {
        Character c = letterNumber.getValue();

        if (simbAlfSaida == null) {
            simbAlfSaida = new Simbolo(
                    Character.toUpperCase(c));
        }

        this.listAlfSaida.addItem(simbAlfSaida.getNome());
        this.gui.addSimbolo(simbAlfSaida, 1);


    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private br.uem.din.yandre.sctmf.view.components.AddRemButtonsPanel addRemButtonsAlf;
    private br.uem.din.yandre.sctmf.view.components.AddRemButtonsPanel addRemButtonsAlfSaida;
    ...
    private br.uem.din.yandre.sctmf.view.components.GenericJList listAlfSaida;
