/*
 * ShowFitaLingRegul.java
 *
 * Created on 13 de Novembro de 2007, 16:47
 */

package br.uem.din.yandre.sctmf.view.modelos_formais.ling_regul.util;
 ...
 */
public class ShowFitaLingRegul extends javax.swing.JDialog {
    
    private static final ShowFitaLingRegul singleton = new ShowFitaLingRegul();
    
    /** Creates new form ShowFitaLingRegul */
    private ShowFitaLingRegul() {
     ...
     * @param fitaMT
     */
     public void showFitaMT(List<Simbolo> fita) {
    ...
    public static final ShowFitaLingRegul getInstance() {
        return singleton;
    }
