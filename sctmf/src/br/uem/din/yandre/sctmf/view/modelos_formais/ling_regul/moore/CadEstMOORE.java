 ...
 */
public class CadEstMOORE extends javax.swing.JPanel implements CEstado {
    private MooreGUI gui = null;
    
    /** Creates new form CadEstMOORE */
    public CadEstMOORE(MooreGUI gui) {
        this.gui = gui;
    ...
    public void observer(Simbolo s, boolean oper, int alf) {
        if(alf == 1){
            if (oper)
                cadEstado.setCbSimbSaida(s,oper);
            else
                cadEstado.setCbSimbSaida(s,oper);
        }
    }
