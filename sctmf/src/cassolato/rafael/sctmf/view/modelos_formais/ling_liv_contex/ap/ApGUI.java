...
public class ApGUI 
    ...
    private void initComponents() {
        ...
        pValSeq.add(validaSequenciaGUI);
   ...
   private void removeActionSimP() {
    ...
    private void validarSequencia() {        
        ValidaSequencia.getInstance().valida(
                this.ap, this.validaSequenciaGUI.getSequencia());
    }
    
    private void observerValSeq(AP ap) {
        ...
        sb.append(">\n");
        this.validaSequenciaGUI.setTextAInf(
                this.validaSequenciaGUI.getTextAInf()+
                sb.toString()
        );
        sb = new StringBuffer();
        
        Simbolo s = ap.getSimBasePilha();
        sb.append("B = <");
        if(aux!=null)
             sb.append(s.getNome());        
        sb.append(">\n");
    ...
    private AP mountAP() {
        ...
        for(Object o :this.listSim.getAllItens())
            ap.addSimbolo(new Simbolo((Character)o));
        
        // Add os simbolos do alfabeto da pilha
        for(Object o :this.listSimPilha.getAllItens())
            ap.addSimboloPilha(new Simbolo((Character)o));
        
        // Add os Estados
        ap.addAllEstados(this.cadEstado.getAllItens());
        
        // Add Estado Inicial
        ap.setEstadoInicial(
                new Estado(this.cbSimbIni.getSelectedItem().toString()));
        
        // Add Estado Inicial Pilha
        ap.setSimbBasePilha(new Simbolo(
                this.cbSimbIniPilha.getSelectedItem().toString().charAt(0)));
        
        // Add Transicoes
        ap.addAllTransicoes(this.getTransicoes());
